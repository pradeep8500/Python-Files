...
def cluster_images(faces_folder_path,output_folder_path,output_folder_path1,predictor_path,face_rec_model_path,output_folder_path2):
...
def compare_folders(pickle_name,output_folder_path,output_folder_path1,output_folder_path2):
...
def rename_folders(face_path,groups_path,file_path):
...
def training_images(output_folder_path,pickle_name):
	...
	for (i, imagePath) in enumerate(imagePaths):
		...
		print(name)
		print('gghfdg',imagePath.split(os.path.sep)[-1])
...
cluster_images(faces_folder_path,output_folder_path,output_folder_path1,predictor_path,face_rec_model_path,output_folder_path2)
if os.path.exists(pickle_name): 
	compare_folders(pickle_name,output_folder_path,output_folder_path1,output_folder_path2)
rename_folders(output_folder_path,output_folder_path1,output_folder_path2)	
